...
const filmsMainContainer = filmMainBoard.querySelector(`.films-list__container`);
const filmsTopRateContainer = mainElement.getElementsByClassName(`films-list--extra`)[0].
querySelector(`.films-list__container`);
const filmsDiscussedContainer = mainElement.getElementsByClassName(`films-list--extra`)[1].
querySelector(`.films-list__container`);
[...Array(cardCount)].forEach(() => render(filmsMainContainer, createFilmCard(), `beforeend`));
render(filmMainBoard, createShowMoreBtn(), `beforeend`);
render(filmsTopRateContainer, createFilmCard(), `beforeend`);
render(filmsDiscussedContainer, createFilmCard(), `beforeend`);
